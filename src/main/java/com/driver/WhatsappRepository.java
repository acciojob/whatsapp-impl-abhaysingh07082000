...
//    private HashSet<String> userMobile;
    private HashMap<String,String>userMobile=new HashMap<>();
...
//        //Otherwise, create the user and return "SUCCESS"
        if(userMobile.containsKey(mobile))throw new Exception("User already exists");
    ...
    public Group createGroup(List<User> users){
        ...
        if(users.size()==2)
        {
            String name=userList.get(2);
              return new Group(,2);
        }
          return new Group("Group 1",customGroupCount);
    }
